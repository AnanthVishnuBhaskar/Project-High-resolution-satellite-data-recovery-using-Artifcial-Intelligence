...
def train():
    ...
    data, label = pd.read_training_data("./crop_train.h5")
     #test_data, test_label = pd.read_training_data("./test_1.h5")
    ...
    #test_pred=srcnn_model.predict(test_data)
    #get data array
#    rmse=rmse_fun(test_label,test_pred)
...
def predict():
    ...
    IMG_NAME = "/home/flipper/ananthsmap/SRCNN-keras/Test/P18212458.png"
...
def predict_loop():
    path1 = '/nfs1/code/akshay/SRCNN-keras/sample_test/train/' #input for prediction
    path2 = '/nfs1/code/akshay/SRCNN-keras/train_high_res/'              #save path for prediction
    ...
    files.sort()
    srcnn_model = predict_model()
    # srcnn_model.load_weights('/nfs1/code/akshay/SRCNN-keras/SRCNN_check.h5')
    srcnn_model.load_weights("3051crop_weight_200.h5")
    # IMG_NAME = "/nfs1/code/akshay/SRCNN-keras/butterfly_GT.bmp"
    # INPUT_NAME = "input2.jpg"
    for i in range(len(files)):
        OUTPUT_NAME = path2 + files[i]
        IMG_NAME = path1 + files[i]
